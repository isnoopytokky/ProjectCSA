...
<body>
	...
	<div class="section-bg2">
		<div class="container">
			<h3 class="homepage-title">จัดสัดส่วนอาหารข้น</h3>
			<br> <br>
			<div class="panel panel-success">
				<div class="panel-heading">
					<h3 class="panel-title">การจัดสัดส่วนอาหารข้น</h3>
				</div>
				<div class="panel-body">
					<table class="table table-striped table-hover" class="form-control"
						class="font-nav" style="font-size: 17px;" border="1"
						bordercolor="#BDBDBD">
						<thead>
							<tr>
								<th width="500">
					...
					<div class="col-sm-offset-1 col-sm-10">
						<a type="button" class="btn btn-danger" name=Rouhg
							href="mixedthick-admin">ผสมสูตรอาหารข้น</a>
					</div>
					<br>
				</div>
			</div>
